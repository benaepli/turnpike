...
- kind: add | category: scheduler | origin: proposer | status: ADMITTED at iteration 34 (judge gain 7, cost 0; iteration-34 top pick) | parent: recovering-receiver-reply-first-deferral (held; this is its no-hold, same-step form and supersedes it)
