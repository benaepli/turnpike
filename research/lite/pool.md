...
- kind: add | category: scheduler | origin: operator-agent | status:
  ADMITTED at iteration 41 (judge gain 8, cost 0, rank 1 of the iteration-40 round; the judge recomputed iteration 38 from its stored chunks and separated the two effects arithmetically: depth>=8 0.820 and P(>=9 | >=8) 0.246 against 0.1586, ratio 1.551, with 1.271 = 0.820 x 1.551 exactly) | parent:
...
- kind: add | category: scheduler | origin: proposer | status: KEPT at iteration 40 (judge gain 7, cost 0, rank 2) | parent: iteration-40 dispatch-draw round
