...
fn explicit_cases() -> Vec<Expr> {
    ...
    let mut cases = vec![
        ...
        Variant(4, "Empty".into(), None), Variant(4, "Payload".into(), Some(b(Int(3)))),
...
impl Generator {
    ...
    fn scalar(&mut self, depth: usize) -> Expr {
        ...
        match self.draw(5) { 0 => Plus(a,c), 1 => Minus(a,c), 2 => Times(a,c), 3 => Min(a,c), _ => Coalesce(Box::new(Some(a)), c) }
    }
    fn expression(&mut self, depth: usize) -> Expr {
        ...
        match op {
            ...
            33 => Variant(3,"Payload".into(),Some(a)), 34 => IsVariant(a,"Payload".into()),
